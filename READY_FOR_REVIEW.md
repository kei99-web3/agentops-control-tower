...
- Local readiness: ready_for_user_review
- Public candidate audit: ready_for_user_review
- Devpost copy audit: ready_for_user_review
- Final submit ready: false
- Next approval target: public_github_repository
- Pending external gates: public_github_repository, public_demo_video, approved_url_writeback, devpost_final_submission
