...
Days until target submit: 5.35
Days until official deadline: 5.56
Urgency: tight
Local validation: needs_more_evidence / failed_count 29
Local validation source: `reports/latest_submission_validation.json`
Local validation note: Full workspace validator output.
