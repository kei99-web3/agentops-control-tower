...
Say official Splunk MCP Server verified only for the local Splunk Enterprise Docker proof with synthetic data; do not claim production Splunk Cloud deployment.
