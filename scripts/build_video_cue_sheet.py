...
SCREEN_FOCUS = {
    ...
    "Splunk/MCP Fit": "reports/latest_local_spl_query_results.html and submission/SPL_QUERIES.md",
...
GUARDRAILS = {
    ...
    "Splunk/MCP Fit": "Say designed for Splunk MCP Server unless live proof is approved and captured.",
