...
def command_steps() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "command": "manual: copy fields from reports\\latest_devpost_final_copy.md into Devpost; select Observability as the primary track; attach architecture_diagram.md; use only approved public repo/video URLs",
