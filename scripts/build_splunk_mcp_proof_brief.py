...
def build_payload(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "grant_fit": (
            "The live Docker proof strengthens the Splunk data story, and the local MCP SDK adapter demonstrates "
        ...
        "claim_upgrade_rule": (
            "Use verified-through-Splunk-MCP wording only after the official Splunk MCP Server app is installed, "
