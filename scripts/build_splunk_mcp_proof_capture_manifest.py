...
def capture_slots(live: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "status": "captured_local_mcp_sdk_adapter_official_pending" if adapter_verified else "pending_live_capture",
            "required_readback": [
            ...
            "safe_artifact": "reports/latest_live_splunk_docker_proof.json mcp_adapter_proof.",
        },
        {
...
def build_payload(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "capture_slots": capture_slots(live),
        ...
        "live_proof_summary": {
            ...
            "official_mcp_blocker": live.get("official_mcp_blocker", "not_recorded"),
        },
        "evidence": rows,
