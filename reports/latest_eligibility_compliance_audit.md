...
- testing_access_gated_by_public_urls: needs_review - Final submission remains blocked until public repo and public video URLs are approved and validated. Evidence: `reports/latest_submission_url_validation.html`
...
- automated compliance evidence ready: fail (testing_access_gated_by_public_urls)
