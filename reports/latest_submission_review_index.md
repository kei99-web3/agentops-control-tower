...
Root type: workspace
Local submission status: needs_more_evidence
Local submission source: reports/latest_submission_validation.json
...
- `reports/latest_approval_execution_handoff.html` (present) - Approval execution handoff: Japanese local handoff for the exact post-approval execution order, readbacks, and stop conditions.
- `submission/APPROVAL_EXECUTION_HANDOFF.md` (present) - Approval execution handoff submission copy: Markdown copy of the local approval execution handoff for interrupted sessions.

### Release Package

- `reports/latest_public_candidate_zip_manifest.html` (present) - Public candidate zip manifest: Shows the local public-candidate ZIP contents and publication boundary.
- `public_repo_candidate/agentops-control-tower/PUBLIC_REPO_CANDIDATE_MANIFEST.md` (present) - Public candidate folder: Shows the clean local folder intended for public GitHub review after approval.
- `release/agentops-control-tower-public-candidate.zip` (present) - Public candidate ZIP: Local ZIP package for user review. It is not published.
...
- `reports/latest_submission_validation.html` (present) - Submission validation: Full local validation report for root, public candidate, and safety scans.
- `reports/latest_release_zip_smoke_test.html` (present) - Release ZIP smoke test: Extracts and rechecks the local public-candidate ZIP.
