...
- pass: video command plan artifact - ready_for_user_review
...
- fail: video dry run approved URLs absent - approved_public_urls.json exists
- fail: video dry run URL gate closed - True
- fail: video dry run repo and video URLs pending - 
- fail: video dry run Go/No-Go final gate - True
